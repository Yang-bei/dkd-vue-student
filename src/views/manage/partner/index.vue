  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="300px">
        <template #default="scope">
          <el-button link type="primary" @click="resetPwd(scope.row)" v-hasPermi="['manage:partner:remove']">重置密码</el-button>
    ...
    <!--查看合作商详情对话框-->
    <!--查看合作商详情对话框-->
    <el-dialog title="查看合作商详情" v-model="partnerInfoOpen" width="500px" append-to-body>
